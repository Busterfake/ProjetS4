...
//void rect_couleur(BITMAP*screen,int x1, int y1, int x2, int y2)
//{
//    if(mouse_x>x1 && mouse_x<x2 && mouse_y>y1 && mouse_y<y2)
//    {
//        rectfill(screen, x1,y1,x2,y2, makecol(121,121,248));
//    }
//    else
//    {
//        rectfill(screen, x1,y1,x2,y2, makecol(225,206,154));
//
//    }
//
//}
